...
import {
  ...
  selectAuthLoading, selectAuthError, selectAuthSuccess,
...
const Register = () => {
  ...
  // Clean up Redux error when leaving
  ...
  const lbl = { fontSize:9, letterSpacing:"0.2em", textTransform:"uppercase", color:"#8A8073", display:"block", marginBottom:7 };
    ...
    <div style={{ minHeight:"100vh", backgroundColor:"#FAF7F2", display:"flex", alignItems:"center", justifyContent:"center", padding:"40px 20px" }}>
      <div style={{ width:"100%", maxWidth:420 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:44 }}>
          <p style={{ fontFamily:"'Montserrat',sans-serif", fontSize:10, fontWeight:500, letterSpacing:"0.28em", textTransform:"uppercase", color:"#C9A84C", marginBottom:12 }}>Join the House</p>
          <h1 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:40, fontWeight:400, color:"#1A1A1A", letterSpacing:"0.04em", marginBottom:12 }}>Create Account</h1>
        ...
        {success && (
          <div style={{ background:"#f0fdf4", border:"1px solid #86efac", color:"#166534", fontSize:11, padding:"11px 14px", marginBottom:20, letterSpacing:"0.04em", borderRadius:6 }}>
            ✅ {success}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:16 }}>
          <div>
            ...
            <input type="text" required style={inp} placeholder="Your full name" value={form.name}
          ...
          <div>
            ...
            <input type="password" required minLength={6} style={inp} placeholder="Minimum 6 characters" value={form.password}
              onFocus={e=>e.target.style.borderColor="#1A1A1A"} onBlur={e=>e.target.style.borderColor="#e5e7eb"}
        ...
        <p style={{ textAlign:"center", fontFamily:"'Montserrat',sans-serif", fontSize:12, color:"#8A8073", marginTop:28 }}>
          ...
          <Link to="/login" style={{ color:"#1A1A1A", fontWeight:500, textDecoration:"underline" }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
